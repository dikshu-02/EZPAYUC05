//UC5 added 2 statements in view-profile to decrypt address and account number before sending
...
public class RegistrationController {
	...
	public ResponseEntity<Customer> getProfile(@RequestHeader("Key") Long customerId)
	{
	    ...
	    if (customer != null) {
	    	//UC5 added these 2 functions to ensure that decrypted values are printed to the user, your call to maybe change it to the service?
