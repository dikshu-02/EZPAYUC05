//UC5...In reset password(), a functionality of our service is called to set all values of fraud_entries to 1.
...
public class PasswordRecoveryService {
	...
	public String createPasswordResetToken(String emailOrMobile) {
		...
		if (customerOptional.isPresent()) {
			...
			//System.out.println("The Token is:"+ recoveryDetails.getToken());
