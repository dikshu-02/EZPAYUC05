//UC5...one functionality called in the authenticate() and the return value is changed from boolean to Integer
...
//	 private MasterDataRepository masterDataRepository;
	...
	@Transactional
	 public Integer authenticate(String userId, String password) {
	        ...
	        if (loginDataOpt.isPresent()) {
	            ...
	            if(loginData.getSuspiciousActivity().getBlockId()==1)
	            	 return 2;
